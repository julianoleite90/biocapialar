...
export default function WarrantyTermsPage() {
  return (
    <main className="flex min-h-screen flex-col items-center bg-white">
      {/* Header */}
      <header className="w-full bg-gradient-to-r from-blue-800 via-blue-700 to-blue-800 py-4 shadow-md relative overflow-hidden">
      ...
      <section className="w-full py-8 md:py-12 bg-white">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="bg-blue-50 p-4 md:p-6 rounded-lg border border-blue-100 shadow-sm mb-8 md:mb-10">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="bg-white p-4 md:p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all">
              <div className="flex flex-col md:flex-row md:items-start">
                              <div className="bg-blue-100 p-2 rounded-full mb-3 md:mb-0 md:mr-4 self-start">
            ...
            <div className="bg-white p-4 md:p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all">
              <div className="flex flex-col md:flex-row md:items-start">
                ...
                <div>
                  ...
                  <div className="mt-3 bg-blue-50 p-3 md:p-4 rounded-md border border-blue-100">
                ...
                <div>
                  ...
                  <div className="space-y-3 text-sm md:text-base text-gray-700">
                    ...
                    <p>
                      ...
                      de 1 (um) frasco. Para compras de kits promocionais (2, 3, 5, ou mais frascos), aplica-se apenas a garantia
      ...
      <footer className="w-full text-white" style={{
        ...
        <div className="mx-auto max-w-5xl px-4 py-8 md:py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
            <div>
              <Image src="/logo-biocapilar.png" alt="Biocapilar" width={150} height={50} className="h-6 w-auto mb-4" />
                              <p className="text-xs md:text-sm text-blue-100 mb-4">
                Biocapilar - Auxiliou mais de 63 mil pessoas a fortalecer os cabelos em todo o Brasil.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-1 md:space-y-2">
                <li>
                  <a href="#" className="text-blue-100 hover:text-white text-xs md:text-sm">
                    Sobre nós
                  </a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-1 md:space-y-2">
                <li className="flex items-start">
                  ...
                  <span className="text-blue-100 text-xs md:text-sm">sac@bourjun.com.br</span>
                </li>
                <li className="flex items-start">
                  <svg
                    className="h-4 w-4 md:h-5 md:w-5 mr-2 mt-0.5"
                  ...
                  <span className="text-blue-100 text-xs md:text-sm">(41) 98454-9172</span>
                </li>
                <li className="flex items-start">
                  <svg
                    className="h-4 w-4 md:h-5 md:w-5 mr-2 mt-0.5"
                  ...
                  <span className="text-blue-100 text-xs md:text-sm">Av. Luiz Boiteux Piazza - Florianópolis/SC</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-blue-700 mt-6 md:mt-8 pt-6 md:pt-8 text-center">
            <p className="text-xs md:text-sm mb-3 md:mb-4">
              © {new Date().getFullYear()} Biocapilar. Todos os direitos reservados.
            </p>
