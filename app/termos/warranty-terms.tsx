    ...
    <main className="flex min-h-screen flex-col items-center bg-white">
      ...
      <section className="w-full py-8 md:py-12 bg-white">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="bg-pink-50 p-4 md:p-6 rounded-lg border border-pink-100 shadow-sm mb-8 md:mb-10">
            <div className="flex items-start">
              <div className="bg-white p-2 rounded-full mr-3 md:mr-4 flex-shrink-0">
                <FileText className="h-5 w-5 md:h-6 md:w-6 text-pink-600" />
              </div>
              <div>
                <h2 className="text-lg md:text-xl font-semibold text-gray-800 mb-2">Compromisso com sua satisfação</h2>
                <p className="text-sm md:text-base text-gray-700">
                  Na Phynamax, acreditamos que a confiança de nossos clientes é nosso maior patrimônio. Por isso,
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="bg-white p-4 md:p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all">
              <div className="flex flex-col md:flex-row md:items-start">
                              <div className="bg-pink-100 p-2 rounded-full mb-3 md:mb-0 md:mr-4 self-start">
            ...
            <div className="bg-white p-4 md:p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all">
              <div className="flex flex-col md:flex-row md:items-start">
                              <div className="bg-pink-100 p-2 rounded-full mb-3 md:mb-0 md:mr-4 self-start">
                <ShieldCheck className="h-5 w-5 md:h-6 md:w-6 text-pink-600" />
                </div>
                <div>
                  ...
                  <div className="mt-3 bg-pink-50 p-3 md:p-4 rounded-md border border-pink-100">
                    <h3 className="font-medium text-pink-800 mb-2 text-sm md:text-base">
            ...
            <div className="bg-white p-4 md:p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all">
              <div className="flex flex-col md:flex-row md:items-start">
                              <div className="bg-pink-100 p-2 rounded-full mb-3 md:mb-0 md:mr-4 self-start">
                <CheckCircle2 className="h-5 w-5 md:h-6 md:w-6 text-pink-600" />
                </div>
                <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-1 md:space-y-2">
                <li>
                  <a href="#" className="text-pink-100 hover:text-white text-xs md:text-sm">
                    Sobre nós
                  </a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-1 md:space-y-2">
                <li className="flex items-start">
                  ...
                  <span className="text-pink-100 text-xs md:text-sm">sac@bourjun.com.br</span>
                </li>
                <li className="flex items-start">
                  <svg
                    className="h-4 w-4 md:h-5 md:w-5 mr-2 mt-0.5"
                  ...
                  <span className="text-pink-100 text-xs md:text-sm">(41) 98454-9172</span>
                </li>
                <li className="flex items-start">
                  <svg
                    className="h-4 w-4 md:h-5 md:w-5 mr-2 mt-0.5"
                  ...
                  <span className="text-pink-100 text-xs md:text-sm">Av. Luiz Boiteux Piazza - Florianópolis/SC</span>
                </li>
              </ul>
            </div>
          </div>

          <div className="border-t border-pink-700 mt-6 md:mt-8 pt-6 md:pt-8 text-center">
            <p className="text-xs md:text-sm mb-3 md:mb-4">
              © {new Date().getFullYear()} Phynamax. Todos os direitos reservados.
            </p>
