...
const RemarketingPage02 = () => {
  ...
  const scrollToKits = () => {
    ...
    const finalUrl = addUtmToUrl('https://full.sale/B4EEqt?src=remarketing-2');
  ...
  useEffect(() => {
    document.title = 'BIOCAPILAR - RMKT 2 - Emagrecimento Natural e Eficaz';
  }, []);
...
export default RemarketingPage02; 