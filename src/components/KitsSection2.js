  ...
  const kits = [
    {
      ...
      image: "/5frascos.png",
      link: "https://full.sale/8mYNoQ?src=pagina2"
    },
    {
      title: "TRATAMENTO PARA",
      days: "3 MESES",
      ...
      image: "/2frascos.png",
      popular: true,
      link: "https://full.sale/k0E9wK?src=pagina2"
    },
    {
      title: "TRATAMENTO PARA",
      days: "30 DIAS",
      ...
      image: "/1frasco.png",
      link: "https://full.sale/eANTht?src=pagina2"
    }
  ];
        ...
        <KitsGrid>
          {kits.map((kit, index) => (
            ...
            >
              ...
              <KitImage>
                <img src={kit.image} alt={`Phynamax Kit ${kit.days} - Tratamento de Emagrecimento Natural com ${kit.products[0].split(' ')[0]} frascos`} />
              </KitImage>
